...
\begin{document}
	...
	\begin{frame}{OpenAPI. \texttt{Swagger} \& \texttt{ReDoc}}
		...
		%\begin{center}
		%	Acceso a Swagger: \href{https://tfm-api.ranii.pro:8443/docs}{\texttt{https://tfm-api.ranii.pro:8443/docs}} \\
		%	Acceso a ReDoc: \href{https://tfm-api.ranii.pro:8443/redoc}{\texttt{https://tfm-api.ranii.pro:8443/redoc}}
		%\end{center}
	\end{frame}
